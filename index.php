...
<body class="text-center">
    ...
    <main>
        <div class="container py-4">
            ...
            <div class="text-end">
                <form action="prihlaseni.php"><input type="submit" value="Přihlásit" class="btn btn-outline-secondary me-2" /></form>
                <!--   <button type="button" class="btn btn-warning red">Registrace</button> -->
            </div>
          </header>
      
          <div class="p-5 mb-4 rounded-3 red">
